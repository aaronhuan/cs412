...
urlpatterns = [
    ...
    path('travelers', views.TravelerListView.as_view(), name="travelers"),
    path('signup/', views.UserRegistrationView.as_view(), name='signup'),
    path('travelers/<int:pk>/', views.TravelerDetailView.as_view(), name="traveler"),
    path('travelers/create', views.TravelerCreateView.as_view(), name='createtraveler'),
    path('travelers/update/<int:pk>', views.TravelerUpdateView.as_view(), name='updatetraveler'),
    path('travelers/delete/<int:pk>', views.TravelerDeleteView.as_view(), name='deletetraveler'),
